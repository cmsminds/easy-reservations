...
$opening_paragraph = sprintf( __( 'This is to update you that your request for cancelling reservation for %1$s in order #%2$s that you placed on %3$s has been deleted. The details about the reservation item are as follows:', 'easy-reservations' ), $item_data->item['item'], $item_data->order_id, $item_data->order_date );
...
<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee;" bordercolor="#eee">
	<tbody>
		...
		<tr>
			...
			<td style="text-align:left; border: 1px solid #eee;"><?php esc_html_e( 'Deleted', 'easy-reservations' ); ?></td>
		</tr>
	</tbody>
</table>
