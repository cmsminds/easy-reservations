										...
										<div class="form-wrapper">
											<div class="bookingDates mb-3">
												<div class="row form-row input-daterange">
													...
													<div class="col-12">
														<div class="d-flex flex-wrap ersrv-edit-reservation-dates-indicators mt-3 pt-2">
															<div class="ersrv-available-dates-notifier"><span><?php esc_html_e('Available Dates', 'easy-reservations'); ?></span></div>
															<div class="ersrv-unavailable-dates-notifier ml-3"><span><?php esc_html_e('Unvailable Dates', 'easy-reservations'); ?></span></div>
															<div class="ersrv-order-reserved-dates-notifier ml-3"><span><?php esc_html_e('Order Reserved Dates', 'easy-reservations'); ?></span></div>
														</div>
													</div>
												</div>
											</div>
