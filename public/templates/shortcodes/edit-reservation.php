...
<div class="wrapper edit-order-wrapper pb-5">
	...
	<div class="contents">
		<div class="container">
											...
											<div class="row form-row input-daterange">
												...
												<div class="col-6">
													<div class="d-flex justify-content-between">
														...
														<a href="#" class="btn-link text-theme-primary"><?php esc_html_e( 'Check Availability', 'easy-reservations' ); ?></a>
													</div>
										...
										<div class="CTA">
											<div class="row form-row align-items-center justify-content-end">
												<div class="col-12 col-md-6 mb-4 mb-md-0">
													...
													<?php esc_html_e( 'Subtotal: ', 'easy-reservations' ); ?><span class="price">$800</span>
													</h4>
												</div>
			...
			<!--   -->
			<div class="group-update-btn d-flex align-items-center justify-content-center">
