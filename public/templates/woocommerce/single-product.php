                ...
                <div class="col-12 col-lg-7 col-xl-8">
                    ...
                    <div class="ship-description info-box">
                        <a class="section-title font-Poppins font-size-24 font-weight-bold d-block color-black text-decoration-none" data-toggle="collapse" href="#ship-description-collapse" role="button" aria-expanded="true" aria-controls="ship-description-collapse">
                            <span class="">Ship Description</span>
                        </a>
                        <div class="collapse show" id="ship-description-collapse">
                            <div class="dropdown-divider"></div>
                            <div class="text-content font-lato font-size-15 line-height-32 font-weight-normal color-seconadry mb-4">
                                <p>If you want a quintessential sailing holiday, then a sailboat charter is for you. With over 7000 sailboats available for rental in destinations across the globe, there is an abundance of choice of oceans to cruise.</p>
                                <p>You can enjoy the thrills of navigating the waves of Brittany or the crystal-clear waters of the Seychelles, or cruise in the glorious Mediterranean where you’ll find our biggest concentration of charter sailboats. Browse our vast selection of boats from professional renters all over the world, and start planning your next sailing adventure; our team of expert advisors will help you find the perfect boat in your dream destination at the very best price!</p>
                            </div>
